...
<html>
<head>
<title><#Web_Title#> - <#menu8_title#></title>
...
function show_sitemap(){
	...
	for(var i=10; i<l2; i++){
		var k = ((i-10)/4 < 1)?0:3;
		$("menu_body").rows[k].cells[(i-10)%4].innerHTML = "<b>" + menuL2_title[i] + "</b>";
		$("menu_body").rows[k].cells[(i-10)%4].className = "head";
	}
	...
	for(var l=10; l < l1; l++){
		...
		var n = ((l-10)/4 < 1)?0:3;
		$("menu_body").rows[n+2].cells[(l-10)%4].innerHTML = map_code;
	}
}
</script>
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <div class="box well grad_colour_dark_blue">
                            <h2 class="box_head round_top"><#menu8_title#></h2>
